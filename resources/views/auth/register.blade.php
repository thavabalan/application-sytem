                            ...
                            <div class="w-100">
                                ...
                                <div class="fv-row">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-3">
                                            <!--begin::Option-->
                                            <label class="form-label fw-bolder text-dark fs-6">Country of Origin</label>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <select name="admission_type" class="form-select form-select-lg form-select-solid" data-control="select2" data-placeholder="Select..." data-allow-clear="true" >
                                                ...
                                                <option value="JAMB UTME">JAMB Regular</option>
                                                <option value="None JAMB">Non - JAMB</option>

<option value="Lateral Entry">Lateral Entry</option>
                                                <option value=" Transfer">University Transfer</option>
                                               
                                                <option value="Foreign Fresh Admission">International Admission</option>
