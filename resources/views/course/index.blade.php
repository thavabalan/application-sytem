                        ...
                        <td class="text-end">
                            ...
                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                                ...
                                <div class="menu-item px-3">
                                    ...
                                    <a href="{{route('deletecourse',$item->id)}}" class="menu-link px-3" data-kt-customer-table-filter="delete_row">Delete</a>
                                </div>
                                <!--end::Menu item-->
                            </div>
                            <!--end::Menu-->
                                ...
                                <div class="modal-dialog modal-dialog-centered mw-650px">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                                            <!--begin::Form-->
                                            <form id="kt_modal_new_card_form" class="form" action="{{route('editcourse',$item->id)}}" method="POST">
                                                @csrf
                                                <!--begin::Input group-->
                                                ...
                                                <div class="row mb-10">
                                                    ...
                                                    <div class="col-md-8 fv-row">
                                                        ...
                                                        <div class="row fv-row">
                                                            ...
                                                            <div class="col-6">
                                                                ...
                                                                <input type="text" class="form-control form-control-solid" placeholder="" name="department" value="{{$item->department}}" />
                                                            ...
                                                            <div class="col-6">
                                                                ...
                                                                <input type="text" class="form-control form-control-solid" placeholder="" name="elegibility_criteria" value="{{$item->elegibility_criteria}}" />
                                                    ...
                                                    <div class="col-md-4 fv-row">
                                                        <!--begin::Label-->
                                                        <label class="d-flex align-items-center fs-6 fw-bold form-label mb-2">
                                                            <span class="required">Degree in view</span>
                                                        </label>
                                                        <input type="text" class="form-control form-control-solid" placeholder="" name="degree_in_view" value="{{$item->degree_in_view}}" />
    ...
    <div class="modal fade" id="kt_modal_new_card" tabindex="-1" aria-hidden="true">
        ...
        <div class="modal-dialog modal-dialog-centered mw-650px">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                    <!--begin::Form-->
                    <form id="kt_modal_new_card_form" class="form" action="{{route('addcourse')}}" method="POST">
                        @csrf
                        <!--begin::Input group-->
                        <div class="d-flex flex-column mb-7 fv-row">
                            <!--begin::Label-->
                        ...
                        <div class="row mb-10">
                            ...
                            <div class="col-md-8 fv-row">
                                ...
                                <div class="row fv-row">
                                    ...
                                    <div class="col-6">
                                        ...
                                        <input type="text" class="form-control form-control-solid" placeholder="" name="department" value="" />
                                    ...
                                    <div class="col-6">
                                        ...
                                        <input type="text" class="form-control form-control-solid" placeholder="" name="elegibility_criteria" value="" />
                            ...
                            <div class="col-md-4 fv-row">
                                ...
                                <input type="text" class="form-control form-control-solid" placeholder="" name="degree_in_view" value="" />
